...
class ClaimAPI extends CCWsiEntityApiBase {
  ...
  @Throws(PermissionException, "If the caller does not have the appropriate permissions")
  @Throws(IllegalArgumentException, "If a currency was supplied for the claimDTO (use a policy currency on the policyDTO instead")
  @Throws(IllegalArgumentException, "If NewLossLocation and LossLocationPublicID are both specified in the ClaimDTO")
  @WsiCheckDuplicateExternalTransaction
