...
class PolicySearchPolicyGenerator
{
  ...
  function generatePolicies( ) : Policy[] {
    ...
    // >>> START: policies used for training

    for (x in 1..21) {

      var suffix = gw.api.util.StringUtil.formatNumber(x, "00")
      ...
      runChunk( \-> {
        ...
        contactMap.put("lab_person:" + suffix, new gw.api.databuilder.PersonBuilder()
            .withLastName("Smith" + suffix)
            .withFirstName("Kevin")
            .withPrimaryPhone(TC_HOME)
            .withPrimaryAddress(new gw.api.databuilder.AddressBuilder()
                .withAddressLine1("1024 Glenwood Avenue")
                .withCountry(TC_US)
                .withPostalCode("60085")
                .withState(TC_IL)
                .withAddressType(TC_HOME)
                .withCity("Waukegan"))
            .withHomePhone("312-336-6210")
            .withTaxID("111-22-00" + suffix)
            .withEmailAddress1("KJSmith@kmail.com")
            .create(bundle))

        policies.add(new gw.api.databuilder.PolicyBuilder()
            // basic policy-level data
            .withExpirationDate(Coercions.makeDateFrom("2030-01-01"))
            .withUnderwritingCo(TC_PARENT)
            .withVerified(true)
            .withOrigEffectiveDate(Coercions.makeDateFrom("2007-01-01"))
            .withAccount("Account 1")
            .withCurrency(CurrencyUtil.getDefaultCurrency())
            .withUnderwritingGroup(TC_ACME_AUTO)
            .withEffectiveDate(Coercions.makeDateFrom("2010-01-01"))
            .withStatus(TC_INFORCE)
            .withPolicyNumber("123456-" + suffix)
            .withTotalProperties(0)
            .withPolicyType(TC_PERSONALAUTO)
            .withTotalVehicles(2)
                // policy contacts
            .withContactInRole(contactMap.get("lab_person:" + suffix), TC_INSURED)
            ...
            .withCoverage(new gw.api.databuilder.PolicyCoverageBuilder()
                .withType(TC_PAUMBICOV)
                .withIncidentLimit(30000bd.ofDefaultCurrency())
            )
            .withCoverage(new gw.api.databuilder.PolicyCoverageBuilder()
                .withType(TC_PAUMPDCOV)
                .withIncidentLimit(30000bd.ofDefaultCurrency())
            )
            .withCoverage(new gw.api.databuilder.PolicyCoverageBuilder()
            ...
            .withRiskUnit(new gw.api.databuilder.VehicleRUBuilder()
                ...
                .withVehicle(new gw.api.databuilder.VehicleBuilder()
                    .withYear(2002)
                    .withLicensePlate("4FRT2" + suffix)
                    .withMake("Mini")
                    .withState(TC_IL)
                    .withModel("Cooper")
                    .withColor("Blue")
                    .withVin("3HBFDSAQW34DVU2" + suffix))
                .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                    .withType(TC_PACOLLISIONCOV)
            ...
            .withEndorsement(new gw.api.databuilder.EndorsementBuilder()
                .withDescription("Driving a Nonowned Vehicle")
                .withFormNumber("PP 02 07")
            )
            .withEndorsement(new gw.api.databuilder.EndorsementBuilder()
                .withDescription("Towing and Labor Costs Coverage")
                .withFormNumber("PP 03 48")
            )
            .create(bundle)
        ) // end addPolicy
    ...
    // <<< END: policies used for training
